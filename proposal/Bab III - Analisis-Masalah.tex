...
Pembelajaran Algoritma dan Struktur Data (ASD) merupakan salah satu komponen penting dalam kurikulum ilmu komputer yang bertujuan membekali mahasiswa dengan kemampuan memahami struktur data, merancang algoritma, serta menganalisis kompleksitas program. Meskipun demikian, berbagai studi menunjukkan bahwa proses pembelajaran ASD masih menghadapi tantangan signifikan, terutama dalam penyampaian konsep yang bersifat abstrak dan dinamis. Berdasarkan informasi yang diperoleh melalui studi literatur dan observasi terhadap praktik pembelajaran saat ini, bagian berikut merangkum fungsi-fungsi utama sistem pembelajaran ASD yang digunakan mahasiswa serta berbagai kendala yang masih ditemui dalam implementasinya.
...
\begin{enumerate}
    ...
    \item Umpan balik terhadap latihan dan pemahaman konsep biasanya tidak diberikan secara cepat. Mahasiswa harus menunggu sesi asistensi atau menunggu waktu koreksi, sehingga proses belajar menjadi kurang responsif dan memperlambat perbaikan miskonsepsi.
...
\begin{longtable}{|p{1.8cm}|p{3cm}|p{7.5cm}|}
...
FR-01 & Sistem mampu melakukan proses \textit{login} sebagai autentikasi pengguna &
Sistem menyediakan dialog \textit{login} yang memvalidasi kredensial pengguna (misalnya akun mahasiswa). Setelah \textit{login}, sistem memuat profil pengguna, riwayat belajar, serta konfigurasi materi yang relevan dengan pengguna tersebut. \\
\hline

FR-02 & Sistem mampu menampilkan alur pembelajaran ASD yang terstruktur &
...
FR-03 & Sistem mampu menghasilkan penjelasan konsep ASD berbasis LLM sesuai konteks materi &
...
FR-04 & Sistem mampu menampilkan contoh kode dan penjelasan langkah demi langkah &
...
FR-05 & Sistem mampu menyediakan latihan soal dan pembahasan otomatis &
...
FR-06 & Sistem mampu memberikan umpan balik terhadap miskonsepsi pengguna &
...
FR-07 & Sistem mampu menyajikan ringkasan materi pada akhir sesi belajar &
...
FR-08 & Sistem mampu menyimpan dan menampilkan riwayat serta progres belajar pengguna &
...
Kebutuhan nonfungsional atau \textit{Non-Functional Requirements} merupakan kebutuhan yang berisi pernyataan mengenai perilaku dan kualitas yang harus dimiliki oleh sistem pembelajaran Algoritma dan Struktur Data berbasis LLM ke depannya. Berikut merupakan tabel kebutuhan nonfungsional dari sistem pembelajaran ASD berbasis LLM dengan pendekatan \textit{guided learning}.

\begin{longtable}{|p{1.8cm}|p{3cm}|p{7.5cm}|}
\caption{Kebutuhan Nonfungsional Sistem Pembelajaran ASD Berbasis LLM}
...
\hline
NF-01 & \textit{Availability} &
Sistem harus selalu tersedia dan dapat diakses oleh pengguna tanpa mengalami \textit{crash} atau gangguan layanan, sehingga proses pembelajaran dapat dilakukan kapan saja tanpa hambatan. \\
\hline

NF-02 & \textit{Security} &
Sistem harus melindungi data pengguna seperti progres belajar, riwayat interaksi, serta kredensial akun dengan menerapkan enkripsi dan kontrol akses yang memadai. \\
\hline

NF-03 & \textit{Compatibility} &
Sistem harus dapat berjalan pada berbagai perangkat seperti laptop, tablet, maupun \textit{smartphone}, serta kompatibel dengan beberapa \textit{browser} modern. \\
\hline

\end{longtable}


Pemenuhan kebutuhan nonfungsional ini bertujuan untuk memastikan sistem memiliki ketersediaan yang baik, aman digunakan, serta memberikan pengalaman belajar yang mudah dan intuitif bagi pengguna.
...
Terdapat beberapa pilihan model LLM yang populer dalam pengembangan aplikasi edukasi berbasis AI, di antaranya GPT-4/GPT-4o, Gemini 1.5, dan Claude 3. Masing-masing model memiliki kelebihan dan kekurangan dalam hal kemampuan \textit{reasoning}, kualitas penjelasan teknis, serta konsistensi keluaran.
...
Setelah mempertimbangkan seluruh aspek tersebut, GPT-4o dipilih sebagai solusi utama karena memberikan keseimbangan terbaik antara kemampuan \textit{reasoning} teknis, stabilitas penjelasan, dan kecocokan dengan kebutuhan pembelajaran ASD yang menuntut akurasi tinggi dan penjelasan yang sistematis.
