...
\begin{longtable}{|p{0.9cm}|p{2.3cm}|p{4.4cm}|p{4.4cm}|}
...
\begin{longtable}{|p{0.8cm}|p{1.8cm}|p{2.2cm}|p{2.5cm}|p{2.5cm}|p{1.2cm}|}
...
FT-07 & Meng\-umpulkan jawaban latihan &
...
FT-14 & Adaptasi konten ber\-dasarkan kelemahan &
