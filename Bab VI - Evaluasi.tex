...
% TODO: isi setelah evaluasi kualitas konten selesai dilakukan.
% Isi dengan:
% 1. Tabel hasil penilaian per soal (15 soal × 3 kriteria × skor 1-3)
% 2. Rata-rata persentase kesesuaian per kriteria dan keseluruhan
% 3. Narasi temuan (topik mana yang skornya tinggi/rendah, pola kesalahan LLM jika ada)

\section{Pembahasan Hasil Evaluasi}

% TODO: isi pembahasan hasil evaluasi setelah data terkumpul.
% Bahas:
% 1. Ringkasan black box: semua 18 skenario lulus → apa artinya
% 2. Ringkasan SUS: skor X → kategori Y → apakah memenuhi indikator keberhasilan (≥68)
% 3. Ringkasan kualitas konten LLM: rata-rata kesesuaian Z% → apakah memenuhi threshold 70%
% 4. Keterkaitan antar hasil: apakah fungsionalitas yang lulus black box juga didukung kualitas konten yang baik
% 5. Keterbatasan evaluasi dan implikasinya
