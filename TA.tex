...
\usepackage{etoolbox} % for \AtBeginEnvironment hooks
\newcolumntype{L}[1]{>{\raggedright\arraybackslash}p{#1}} % left-aligned p column
\AtBeginEnvironment{longtable}{\small\setstretch{1}}
\AtBeginEnvironment{tabular}{\small\setstretch{1}}
...
\setlength\emergencystretch{3em} % fleksibilitas line-breaking untuk kata yang tidak dapat di-hyphenasi
\global\hfuzz=3pt % suppress warnings for overflows < 3pt (cosmetically negligible)
...
% --- Hapus bold/font formatting pada sitasi ---
\renewcommand{\cite}{\textup{\parencite}}
% --- Tambah koma antara nama penulis dan tahun: (Minaee, 2025) ---
